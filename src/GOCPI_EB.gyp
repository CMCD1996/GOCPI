...
column_headers = [
    ...
    'Prod_Description', 'Flow_Code', 'Flow_Description', 'Year', 'Value(TJ)'
]
f1 = open(IEAWEBAK, 'r')
...
Conversion = [
    'Energy Sector Consumption', 'Electricity Plants', 'Heat Plants',
    'Petroluem Refineries', 'Total Conversion'
]
Consumption = [
    'Residential', 'Commercial', 'Industry', 'Agriculture', 'Transport',
    'Other', 'Non Energy', 'Bunkers', 'Total Final Consumption'
]
...
Energy_Flows = [
    ...
    'Food and tobacco', '"Paper, pulp and printing"', 'Wood and wood products',
    ...
    'Heat output', 'Heat output-main activity producer CHP plants',
...
Energy = [
    'Solid Fuels', 'Natural Gas', 'Crude Oil', 'Diesel Oil', 'Kerosene', 'LPG',
    'Motor Spirit', 'Naphtha', 'Heavy Fuel Oil', 'Other Petroleum Products',
    'Nuclear Energy', 'Biomass', 'Hydro power', 'Wind energy', 'Solar Energy',
    'Industrial Wastes', 'Derived Heat', 'Electricity', 'Total'
]
...
Enery_Types = [
    'Hard coal (if no detail)', 'Brown coal (if no detail)', 'Anthracite',
    'Coking coal', 'Other bituminous coal', 'Sub-bituminous coal', 'Lignite',
    'Patent fuel', 'Coke oven coke', 'Gas coke', 'Coal tar'
    'BKB', 'Gas works gas', 'Coke oven gas', 'Blast furnace gas',
    'Other recovered gases', 'Peat', 'Peat products',
    'Oil shale and oil sands', 'Natural gas',
    'Crude/NGL/feedstocks (if no detail)', 'Crude oil', 'Natural gas liquids',
    'Refinery feedstocks', 'Additives/blending components',
    'Other hydrocarbons', 'Refinery gas', 'Ethane',
    'Liquefied petroleum gases (LPG)', 'Motor gasoline excl. biofuels',
    'Aviation gasoline', 'Gasoline type jet fuel',
    'Kerosene type jet fuel excl. biofuels', 'Other kerosene',
    'Gas/diesel oil excl. biofuels', 'Fuel oil', 'Naphtha',
    ...
    'Biogasoline'
    'Biodiesels', 'Bio jet kerosene', 'Other liquid biofuels',
