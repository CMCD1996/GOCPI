...
These a briefly described as follows:
\begin{enumerate}
	\item \textbf{Data Availability}: Publicly available and accurate data is hard to find when devising energy system.
	This project was able to access publicly available from government agencies and global reporting entities.
	However, data in different jurisdictions is recorded differently, making a consist
