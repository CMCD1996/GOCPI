...
Our meetings were a weekly highlight, giving a sense normalcy during the depths of the COVID-19 Lockdowns.
...
OseMOSYS is formulated as a linear programme. The energy system required a commercial solver to solve the problem.
A few commercial solvers were considered.

\subsubsection{Gurobi}
The Gurobi suite of optimisation products
was considered as the default commercial solver.
