...
\begin{titlepage}
	...
	{\large\textit{Author: Connor McDowall \\Supervisor:}}\\
...
Python \textbf{[X]} was the primary coding language for the GOCPI project. 
GOCPI's objective is to enable any user to design and model their own energy systems to inform investment and policy decisions.
...
\subsubsection{Anaconda Package Management}
