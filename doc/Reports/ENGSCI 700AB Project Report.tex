...
\subsection{Forecasting Energy Systems: NZ Example}
...
The WACC, cost of equity and pre-tax cost of debt are calculated as follows:
\begin{align}
...
\quad\leftrightarrow\quad
	...
	\end{split}
\end{equation*}
The regions used in the energy system example are New Zealand and Australia. Both are public entities by nature.
...
Each Government's respective Treasury produces these reports.
Cost of borrowings (i), Equity (E) and Debt (D) are reported in each region's annual financial reports produced by Treasury ()
Risk free rates were derived from average 10 Year Government bond yields using data from each region's respective Reserve Bank (Reserve Bank of New Zealand \cite{RBNZ_WIR} and Reserve Bank of Australia \cite{RBA_ZCL}). 
