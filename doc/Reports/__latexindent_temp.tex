...
\begin{wrapfigure}{l}{0.5\textwidth}
	\begin{center}
		\includegraphics[width=0.48\textwidth]{URES.png}
	\end{center}
...
the Ministry of Business, Innovation and Employment (\cite{MBIE_ESEM}). 
Table \ref{table:2} describes the technologies mapped in the New Zealand RES.
The Australian RES was derived from the Department of Industry, Science, Energy and Resources energy data set (\cite{DOEA_ESEM}).
...
\begin{table}[H]
	...
	\begin{tabular}{||c | c||} 
	 ...
	 \hline\hline
	 Production & Year, Technology, Timeslice, Fuel, Emission\\ 
	 & Mode of Operation, Region, Season, Day Type \\
	 & Daily Time Bracket, Storage \\
	 \hline  
	 Conversion & Trade, Activities, Demand Profiles, Costs \\
	 & Storage Rates, Conversion Rates, Emission Limits etc \\
	 \hline
	 Consumption& Demand, Storage Rates, Production \\
	 & Emissions Penalties, Operating Costs, Technology Use etc\\
	 \hline
	\end{tabular}
...
The \textbf{Energy Balance} describe the base year energy production, conversion and consumption to be forecast moving forward.

The \textbf{trade elationships} describe the exchange of energy-related resources between modelled regions in the energy system.
