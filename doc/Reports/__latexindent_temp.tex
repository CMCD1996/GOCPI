...
The OseMOSYS methodology was the next best alternative to the TIMES for modelling large scale energy systems.
OseMOSYS proved to be the better of the two methods as more closely aligned with the overall scope and purpose of the project.
...
This online community are developing three versions of OseMOSYS accompanied with exemplar energy systems.


The OseMOSYS implementation and CPLEX solver needed solve the systems the formulation of an lp-format file through the combination of user-defined data and model text files.
...
\subsection{package Interface and Distribution}
\newpage
\section{Results}
\newpage
\section{Discussion}
