...
The coronavirus pandemic has accelerated a shift away from fossil fuels and emphasised the need to adopt sustainable technologies to drive an economic recovery.
...
Financial concept such as Return on Investment (ROI) and Net Present Value (NPV) analysis drive the decisions to invest sustainably.
Sustainable technologies have seen significant cost reductions over the last decade leading to positive prospects for investors.
These developments improve the feasibility of the energy transition in a timely manner.
However, there are educational disparities between policy makers, governments, industry and consumers.
Major stakeholders know a transition must happen swiftly, but not the implementation timeline or impact on their energy system in a successful transition.
Stakeholders have different needs and reside within different energy systems. They may address changes in their best interest without considering the other stakeholders equitably.
...
Energy modelling involves huddling several technical barriers.
Large quantities of energy related data is required to build accurate systems.
...
These models can be difficult to formulate and be hard to understand.
The complexity of energy modelling leads to the need for powerful commercial solvers to solve the energy system models.
...
Most noticeably, It is hard to define an effective transition strategy which aligns with both the United Nations Sustainable Development Goals and Paris Agreement.
...
Firstly, GitHub pages functionality and a custom domain name were initialised for the GitHub repository.
In the Gemfile shown in figure \ref{fig:WD}, ruby gem commands were added control the website's theme, markdown parsing and GitHub pages adaptation.
...
Committing and push changes to the GitHub repository generates updates for website content.
...
Carbon taxes are imposed as a constraint in the OseMOSYS methodology.
...
OseMOSYS was a better alternative as the methodology is more intuitive and captures the complexity required for energy modelling.
...
\begin{enumerate}
	...
	\item A pipeline to use IBM Cloud services to solve energy system models using the IBM  inform decisions.
	...
	\begin{enumerate}
		\item Navigation: Navigate file structures to access key resources and data.
		...
		\item Forecasting: Generate energy balances and forecast energy and financial information.
